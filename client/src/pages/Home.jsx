  ...
  const features = [
    {
      ...
      description: 'Bridge the gap between academic talent and real-world opportunities.'
    },
    {
      icon: <Briefcase className="w-8 h-8" />,
      title: 'Verified Skills & Badges',
      description: 'Students earn verified badges through practical task completion.'
    },
    {
  ...
  const testimonials = [
    {
      ...
      content: 'Hubinity helped me gain real-world experience and build my portfolio. The verification system gave me credibility with employers.',
      rating: 5
    },
    {
      name: 'Mike Rodriguez',
      role: 'Startup Founder',
      content: 'We found amazing talent through Hubinity. The skill verification process ensures we get qualified students for our projects.',
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Hubinity connects talented students with innovative startups. Build your future, one project at a time." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-gray-200">
              Hubinity bridges the gap between talented students and innovative startups. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle">
              Our platform offers unique features that make learning and collaboration seamless
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="card text-center hover:shadow-medium transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sign up as a student or startup and build your profile with skills, experience, and goals.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Browse tasks, apply for projects, and work together through our integrated platform.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Complete tasks, earn verified badges, and download professional certificates.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-primary-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle">
              Hear from students and startups who have transformed their careers and businesses
            </p>
          </div>
